 ...
 */
export let saveServices = async (req: Request, res: Response, next: NextFunction) => {
 ...
 * @description This Function is used to update product.
 */
export let getServices = async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
export let getSingleServices = async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 * @description This Function is used to delete single User.
 */
export let updateServices = async (req: Request, res: Response, next: NextFunction) => {
    const errors = validationResult(req);
    if (errors.isEmpty()) {
        try {
 ...
 * @description This Function is used to delete single User.
 */
export let deleteServices = async (req: Request, res: Response, next: NextFunction) => {
    try {
