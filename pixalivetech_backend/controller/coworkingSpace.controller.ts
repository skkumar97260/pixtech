 ...
 */
export let saveWorkingSpace = async (req: Request, res: Response, next: NextFunction) => {
 ...
 * @description This Function is used to update product.
 */
export let getWorkingSpace = async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
export let getSingleWorkingSpace = async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 * @description This Function is used to delete single User.
 */
export let updateWorkingSpace = async (req: Request, res: Response, next: NextFunction) => {
    const errors = validationResult(req);
    if (errors.isEmpty()) {
        try {
 ...
 * @description This Function is used to delete single User.
 */
export let deleteWorkingSpace = async (req: Request, res: Response, next: NextFunction) => {
    try {
